...
class UserController extends BaseController
{
    ...
    public function getUserProfile($user_id)
    {
        ...
        try {
            $this->userModel->updateActivity((int)$user_id);
    ...
    public function getUserEquipment($user_id)
    {
        ...
        try {
            ...
            if (!$this->equipmentModel)
                $this->equipmentModel = new Equipment($this->pdo);
    ...
    public function getUserResources($user_id)
    {
        ...
        try {
            ...
            if (!$this->resourceModel)
                $this->resourceModel = new Resource($this->pdo);
    ...
    public function equipItem()
    {
        ...
        try {
            $this->userModel->updateActivity((int)$data['user_id']);
            if (!$this->equipmentModel)
                $this->equipmentModel = new Equipment($this->pdo);
    ...
    public function loginUser()
    {
        ...
        try {
            ...
            $this->userModel->processOfflineRecovery($user['user_id']);
